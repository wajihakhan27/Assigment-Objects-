...
// OBJECT OF ALIAS :Type aliases in TypeScript are used to create new names for existing types,in the simple way that are used to simplify complex types or to create reusable types.
type Product = {
    id: number;
    name: string;
    price: number;
...
console.log(`Product Descrciption:${product.description}`);

// UNION ALIAS:  
type EmployesDetails = string | Number | boolean;
let depertment_1 = {
